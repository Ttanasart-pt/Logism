...
class MenuEdit extends Menu {
    ...
    public MenuEdit(LogisimMenuBar menubar) {
        ...
        int controlKey        = getToolkit().getMenuShortcutKeyMaskEx();
        int controlShiftKey   = controlKey | InputEvent.SHIFT_DOWN_MASK;

        undo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z, controlKey));
		redo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Y, controlKey));
        cut.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, controlKey));
        copy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, controlKey));
        paste.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, controlKey));
        delete.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, 0));
        dup.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, controlKey));
        selall.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, controlKey));
        raise.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_UP, controlKey));
        lower.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, controlKey));
        raiseTop.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_UP, controlShiftKey));
        lowerBottom.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, controlShiftKey));
