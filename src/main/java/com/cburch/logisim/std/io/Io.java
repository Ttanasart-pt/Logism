...
public class Io extends Library {
    ...
    static final Attribute<Color> ATTR_COLOR = Attributes.forColor("color", getFromLocale("ioColorAttr"));
    ...
    private static FactoryDescription[] DESCRIPTIONS = {
        new FactoryDescription("Button", "Button", getFromLocale("buttonComponent"), "button.svg", "Button"),
        new FactoryDescription("Joystick", "Joy", getFromLocale("joystickComponent"), "joystick.svg", "Joystick"),
        new FactoryDescription("Keyboard", "Keyboard", getFromLocale("keyboardComponent"), "keyboard.svg", "Keyboard"),
        new FactoryDescription("LED", "LED", getFromLocale("ledComponent"), "led.svg", "Led"),
        new FactoryDescription("7-Segment Display", "7seg", getFromLocale("sevenSegmentComponent"), "7seg.svg", "SevenSegment"),
        new FactoryDescription("Hex Digit Display", "Hex", getFromLocale("hexDigitComponent"), "hexdig.svg", "HexDigit"),
        new FactoryDescription("DotMatrix", "Matrix", getFromLocale("dotMatrixComponent"), "dotmat.svg", "DotMatrix"),
        new FactoryDescription("TTY", "TTY", getFromLocale("ttyComponent"), "tty.svg", "Tty"),
    };
